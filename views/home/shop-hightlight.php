		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-4 col-md-6 col-12">
					...
					<!-- Start Single List  -->
					<?php for ($i = 0; $i < count($listCate); $i++): ?>
						<?php foreach($loadTopView as $list):?>
						<?php if ($list['category'] == $listCate[$i]['id']): ?>
							<div class="single-list">
						<div class="row">
							<div class="col-lg-6 col-md-6 col-12">
							...
							<div class="col-lg-6 col-md-6 col-12 no-padding">
								<div class="content">
									<h5 class="title"><a href="../views/indexProdetail.php?id=<?=$list['product_id']?>&act=loadOne&name=<?=$listCate[$i]['category_name']?>"><?=$list['product_name']?></a></h5>
									<p class="price with-discount"><?=number_format($list['product_price'])?>VNĐ</p>
								</div>
							</div>
						</div>
