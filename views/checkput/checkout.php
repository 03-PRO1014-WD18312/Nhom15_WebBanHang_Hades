						...
						<div class="checkout-form">
							...
							<form class="form" method="post" action="#">
								<div class="row">
									...
									<button type="submit" class="btn">Order n</button>
									<!-- <div class="col-lg-6 col-md-6 col-12">
										<div class="form-group">
								...
								<div class="content">
									...
									?>
										<li style="display: flex; align-items: center; margin-bottom: 35px;">
											<a href="../views/indexCart.php" title="Update"><i class="fa fa-pencil-square" aria-hidden="true"></i></a>
											<a style="width: 40px; height: 40px; margin-left: 15px; margin-right: 10px;" class="cart-img" href="#"><img src="../images/<?=$cart['product_image']?>" alt="#"></a>
