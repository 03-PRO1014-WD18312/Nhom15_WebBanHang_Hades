						...
						<div class="shop-sidebar">
								...
								<div class="single-widget category">
									...
									<ul class="categor-list">
										<?php foreach($listCate as $cate):?>
											<li><a href="../views/indexProduct.php?id=<?=$cate['id']?>&act=loadCate"><?=$cate['category_name']?></a>
										<?php endforeach;?>
								...
								<div class="single-widget recent-post">
									...
									<?php foreach($listRecent as $list):?>
										...
										<div class="image">
											<img src="../images/<?=$listCate[$i]['category_name']?>/<?=$list['product_image']?>" alt="#">
										</div>
										<div class="content">
											<h5><a href="./indexProdetail.php?id=<?=$list['product_id']?>&act=loadOne&name=<?=$listCate[$i]['category_name']?>"><?=$list['product_name']?></a></h5>
								...
								<div class="shop-top">
									<div class="shop-shorter">
										<div class="single-shorter">
											<label>Show :</label>
											<select name="loadLitmit">
												<option value="litmit9" selected="selected">09</option>
												<option value="litmit15">15</option>
												<option value="litmit25">25</option>
												<option value="litmit30">30</option>
											</select>
										</div>
										<div class="single-shorter">
											<label>Sort By :</label>
											<select name="sort_option">
												<option value="sortName" selected="selected">Name</option>
									...
									<a id="prevLink" href="?page=<?= ($page - 1 > 0) ? $page - 1 : $totalPages  ?>" class="prev-arrow"><i class="fa fa-long-arrow-left" aria-hidden="true"></i></a>
									<?php for ($i = 1; $i <= $totalPages; $i++) : ?>
										...
										<?php elseif ($i === $page - 3 || $i === $page + 3) : ?>
											...
											<?php if($i === $page + 3):?>
												<a href="?page=<?= $totalPages ?>" class="<?= $page === $i ? 'active' : '' ?>"><?= $totalPages ?></a>
												<?php endif;?>
										<?php endif; ?>
									<?php endfor; ?>
							...
							<div class="col-lg-4 col-md-6 col-12">
								<div class="single-product">
									...
									<div class="product-content">
										<h3><a href="./indexProdetail.php?id=<?=$pro['product_id']?>&act=loadOne&name=<?=$listCate[$i]['category_name']?>"><?=$pro['product_name']?></a></h3>
