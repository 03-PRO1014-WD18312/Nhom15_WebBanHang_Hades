						...
						<div class="row">
							<div class="col-12">
								...
								<div class="shop-top">
									...
									<a id="prevLink" href="?page=<?= $page - 1 ?>" class="prev-arrow"><i class="fa fa-long-arrow-left" aria-hidden="true"></i></a>
							...
							<div class="col-lg-4 col-md-6 col-12">
								<div class="single-product">
									...
									<div class="product-content">
										<h3><a href="./indexProdetail.php?id=<?=$list['product_id']?>&act=loadOne&name=<?=$listCate[$i]['category_name']?>"><?=$pro['product_name']?></a></h3>
